...
- [x] **MEDIUM** — Split `KnowledgeStore` (1482 lines) into domain-focused mixins (`EntityMixin`, `ProvenanceMixin`, `RelationshipMixin`, `RunMixin`) composed into `KnowledgeStore` — reduces file size while keeping the single public class
