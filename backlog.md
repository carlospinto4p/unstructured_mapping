...
- [ ] **HIGH** — Split `test_knowledge_graph.py` (1796 lines) into focused test modules: `test_kg_entities.py`, `test_kg_provenance.py`, `test_kg_relationships.py`, `test_kg_history.py` — improves test navigation and makes it easier to run subsets
